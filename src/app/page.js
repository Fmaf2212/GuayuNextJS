...
import fraseFirstBg from '../../public/images/fraseFirstBg.png'
import bgTopMain from '../../public/images/bgTopMain.webp'
import bgTopMain1x from '../../public/images/bgTopMain1x.webp'
import saqsaywaman from '../../public/images/saqsaywaman.webp'
import unProductoDeSN from '../../public/images/unProductoDeSN.png'
import barraAndina3x from '../../public/images/barraAndina3x.png'
import ramaDerecha from '../../public/images/ramaDerecha.webp'
import bgAzul3x from '../../public/images/bgAzul3x.png'
import bgAzul1x from '../../public/images/bgAzul1x.png'
import bajoEnCalorias from '../../public/images/bajoEnCalorias.png'
import sinOctogonos from '../../public/images/sinOctogonos.png'
import botellaGuayuAzul3x from '../../public/images/botellaGuayuAzul3x.webp'
import decoracionAndino from '../../public/images/decoracionAndino.png'
import bgVerde1x from '../../public/images/bgVerde1x.png'
import bgVerde3x from '../../public/images/bgVerde3x.png'
import botellaGuayuVerde from '../../public/images/botellaGuayuVerde.webp'
import hojaDeCocaLegal from '../../public/images/hojaDeCocaLegal.webp'
import ramaIzquierda from '../../public/images/ramaIzquierda.webp'
import bgWhiteLineas from '../../public/images/bgWhiteLineas.png'
import bgRio3x from '../../public/images/bgRio3x.webp'
import bgRio1x from '../../public/images/bgRio1x.webp'
import carbonNeutral from '../../public/images/carbonNeutral.png'
import bgRedesSociales from '../../public/images/bgRedesSociales.png'
import iconFacebook from '../../public/images/iconFacebook.png'
import iconInstagram from '../../public/images/iconInstagram.png'
import botellaGuayuAzul3xV2 from '../../public/images/botellaGuayuAzul3xV2.webp'
...
export default function Home() {
  ...
  return (
    <>
      <section className='h-[1010px] bg-no-repeat bg-top max-sm:bg-center relative z-20'>
        <header>
      ...
      <section className='max-md:h-[714px] h-[589px] bg-no-repeat bg-center relative z-10 -mt-[220px] flex flex-col items-center justify-center gap-28'>
        <span></span>
      ...
      <section className='bg-white flex flex-col sm:gap-10 max-sm:gap-4 gap-20 items-center justify-center relative h-[446px] max-[769px]:h-[600px] max-[500px]:h-[446px] max-sm:pt-8 max-[500px]:pt-0 max-[500px]:-mt-10 pt-0 pb-[26px]'>
        <img src={unProductoDeSN} alt="unProductoDeSN" width={223} height={81} className='max-[500px]:w-[123px] sm:w-[163px]' />
      ...
      <section className='max-sm:bg-cover bg-no-repeat max-sm:bg-left bg-center max-md:h-[776px] h-80 max-md:gap-8 relative z-0 flex justify-center items-center max-md:flex-col-reverse max-sm:p-4'>
        <div className='max-md:max-w-[680px] max-w-[463px] flex items-end max-md:flex-row-reverse'>
          ...
          <img
              src={botellaGuayuAzul3x} alt="botellaGuayuAzul3x" width={297} className='max-md:hidden'/>
          <img
              src={botellaGuayuAzul3xV2} alt="botellaGuayuAzul3xV2" className='max-md:max-w-[275px] max-w-[455px] w-full max-md:-ml-[100px] md:hidden max-[321px]:max-w-[245px]'/>
        </div>
      ...
      <section className='max-sm:bg-cover bg-no-repeat bg-center max-sm:bg-right max-md:h-[776px] h-80 relative z-10 flex justify-center items-center max-md:flex-col max-sm:p-4'>
        ...
        <div className='max-w-[429px] w-full flex justify-start max-sm:justify-center items-end max-md:flex-row-reverse'>
          <img
              src={botellaGuayuVerde} alt="botellaGuayuVerde" className='relative top-6 max-w-[255px] max-[500px]:max-w-[225px] max-[321px]:max-w-[185px]'/>
      ...
      <section className='h-[340px] bg-white bg-no-repeat bg-center relative z-0 flex flex-col items-center justify-center gap-7'>
      ...
      <section className='max-sm:h-[669px] h-[359px] bg-no-repeat bg-center relative z-0 flex flex-col items-center justify-center gap-7'>
      ...
      <footer className='h-[202px] bg-white bg-no-repeat bg-left relative z-0 min-[992px]:py-2.5 flex flex-col items-center justify-center gap-4'>
